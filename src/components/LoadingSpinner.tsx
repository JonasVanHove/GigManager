  ...
  if (fullScreen) {
    return (
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 flex flex-col items-center justify-center gap-8 px-6 max-w-md">
          {/* Logo */}
          <div className="relative">
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-brand-500 to-orange-500 blur-xl opacity-40" />
          ...
          <div className="text-center space-y-1">
            <h2 className="text-xl font-bold tracking-tight text-white">GigsManager</h2>
            <p className="text-xs font-light text-slate-500 tracking-wide">Performance Management</p>
          </div>
